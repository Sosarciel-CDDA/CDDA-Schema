...
/**近战武器的Flag列表 */
export declare const MeleeItemFlagList: readonly ["ALLOWS_BODY_BLOCK", "ALWAYS_TWOHAND", "BIONIC_WEAPON", "DIAMOND", "MESSY", "NO_CVD", "NO_RELOAD", "NO_UNWIELD", "NONCONDUCTIVE", "POLEARM", "REACH_ATTACK", "REACH3", "SHEATH_AXE", "SHEATH_GOLF", "SHEATH_KNIFE", "SHEATH_SWORD", "SPEAR", "UNARMED_WEAPON", "WHIP"];
/**通用物品的flag列表 */
