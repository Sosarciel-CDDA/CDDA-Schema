import { EocEffect, IDObj, LocObj, NumObj } from "./Eoc";
...
/**任务来源 列表 */
declare const MissionOriginList: readonly ["ORIGIN_GAME_START", "ORIGIN_OPENER_NPC", "ORIGIN_ANY_NPC", "ORIGIN_SECONDARY", "ORIGIN_COMPUTER"];
/**任务来源 */
...
/**空的任务对话字典 */
export declare const EmptyMissionDialog: MissionDialog;
/**任务效果 */
type MissionEffect = {
    /**eoc效果 */
...
/**地块匹配类型 列表 */
export declare const OMTMatchTypeList: readonly ["EXACT", "TYPE", "PREFIX", "CONTAINS"];
/**地块匹配类型
 * 如果未指定, 则默认为 TYPE
 */
