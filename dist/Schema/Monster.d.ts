...
/**怪物的身体类型 列表 */
export declare const MonsterBPList: readonly ["angel", "bear", "bird", "blob", "crab", "dog", "elephant", "fish", "flying insect", "frog", "gator", "horse", "human", "insect", "kangaroo", "lizard", "migo", "pig", "spider", "snake"];
/**怪物的身体类型 */
